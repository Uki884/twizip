var downloadZip = (() => {
  ...
  function r(e, n, i) {
    if (
      (void 0 === n || n instanceof Uint8Array || (n = d(n)),
    ...
    if ("string" == typeof e) return { i: n, o: i, A: d(e) };
    if (e instanceof Blob) return { i: n, o: i, A: e.stream() };
    if (e instanceof Uint8Array || e instanceof ReadableStream)
      return { i: n, o: i, A: e };
    if (e instanceof ArrayBuffer || ArrayBuffer.isView(e))
      return { i: n, o: i, A: o(e) };
    if (Symbol.asyncIterator in e) return { i: n, o: i, A: s(e) };
  ...
  var u = new WebAssembly.Instance(
  ...
  function b(e) {
    ...
    return (
      ...
      n.setUint32(4, 754976768),
      w(e.o, n, 10),
      n.setUint16(26, e.i.length, 1),
      o(n)
    );
  }
  async function* C(e) {
    ...
    if (("then" in n && (n = await n), n instanceof Uint8Array))
      yield n, (e.u = B(n, 0)), (e.l = BigInt(n.length));
    else {
      e.l = 0n;
      const i = n.getReader();
      for (;;) {
  ...
  function D(e, n) {
    ...
    return (
      ...
      f.setUint32(4, e.u, 1),
      n
        ? (f.setBigUint64(8, e.l, 1), f.setBigUint64(16, e.l, 1))
        : (f.setUint32(8, a(e.l), 1), f.setUint32(12, a(e.l), 1)),
      o(f)
    );
  }
  function Q(e, n, f) {
    ...
    return (
      ...
      r.setUint16(8, 2048),
      w(e.o, r, 12),
      r.setUint32(16, e.u, 1),
      r.setUint32(20, a(e.l), 1),
      r.setUint32(24, a(e.l), 1),
      r.setUint16(28, e.i.length, 1),
      r.setUint16(30, f ? 28 : 0, 1),
      r.setUint16(40, 33204, 1),
      r.setUint32(42, a(n), 1),
      o(r)
    );
  }
  function g(e, n) {
    ...
    return (
      a.setUint16(0, 1, 1),
      a.setUint16(2, 24, 1),
      a.setBigUint64(4, e.l, 1),
      a.setBigUint64(12, e.l, 1),
      a.setBigUint64(20, n, 1),
      o(a)
    );
  }
  return (e) =>
        ...
        (async function* (e) {
          ...
          if (A || r >= 0xffffffffn) {
            ...
            e.setUint32(0, 1347094022),
              ...
              e.setBigUint64(40, d, 1),
              e.setBigUint64(48, r, 1),
              e.setUint32(56, 1347094023),
              e.setBigUint64(64, r + d, 1),
              e.setUint32(72, 1, 1),
              yield o(e);
          }
          const u = i(22);
          u.setUint32(0, 1347093766),
            u.setUint16(8, f(s), 1),
            u.setUint16(10, f(s), 1),
            u.setUint32(12, a(d), 1),
            u.setUint32(16, a(r), 1),
            yield o(u);
        })(
          (async function* (e) {
            for await (const n of e)
              n instanceof File || n instanceof Response
                ? yield r(n)
                : yield r(n.input, n.name, n.lastModified);
          })(e)
        )
      ),
      {
